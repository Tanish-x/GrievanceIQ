...
function App() {
  ...
  useEffect(() => {
    if (isConnected && account) {
      setShowWelcome(true);
      toast.success(`Welcome to GrievancelQ! Connected to ${account.slice(0, 6)}...${account.slice(-4)}`, {
        icon: '🎉'
      });
  ...
  if (isConnecting || !isInitialized) {
    const loadingMessage = isConnecting 
      ...
      : 'GrievancelQ शुरू हो रहा है... • Initializing GrievancelQ...';
      ...
      <AnimatePresence>
        {showWelcome && isConnected && (
          ...
          >
            ...
            >
              🎉 ग्रीवांस आईक्यू में आपका स्वागत है! • Welcome to GrievancelQ! Your wallet is now connected and you can access all governance services.
            </Alert>
          </motion.div>
        )}
      </AnimatePresence>
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" sx={{ color: '#7B3F00', fontWeight: 500 }}>
                © {currentYear} GrievancelQ. सभी अधिकार सुरक्षित • All rights reserved.
              </Typography>
            </Grid>
