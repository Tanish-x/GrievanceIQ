...
export const Web3Provider = ({ children }) => {
  ...
  const resetConnection = useCallback(() => {
    ...
    // Clear localStorage
    localStorage.removeItem('grievancelq_address');
    localStorage.removeItem('grievancelq_token');
    localStorage.removeItem('grievancelq_connected');
  }, []);
  ...
  const connectWallet = useCallback(async () => {
    ...
    try {
      ...
      localStorage.setItem('grievancelq_address', sanitizedAddress);
      localStorage.setItem('grievancelq_token', token);
      localStorage.setItem('grievancelq_connected', 'true');
  ...
  useEffect(() => {
    const autoConnect = async () => {
      ...
      const wasConnected = localStorage.getItem('grievancelq_connected');
      const storedAddress = localStorage.getItem('grievancelq_address');
      const storedToken = localStorage.getItem('grievancelq_token');
