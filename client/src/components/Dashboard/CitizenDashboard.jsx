      ...
      >
        <Box sx={{ mb: 4, textAlign: 'center' }}>
          ...
          <Typography variant="h4" className="bharat-title" gutterBottom sx={{ color: '#FF9933', mt: 1 }}>
            GrievancelQ Digital Identity Platform
          </Typography>
                ...
                <CardContent sx={{ p: 4 }}>
                  ...
                  <Box sx={{ mt: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mt: 1, fontStyle: 'italic' }}>
                      "Powered by GrievancelQ - Connecting India's Digital Future with Blockchain Technology"
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
                    ...
                    <Alert severity="info" className="bharat-alert bharat-alert-info" sx={{ mb: 4 }}>
                      <Box>
                        <Typography sx={{ fontWeight: 700, mb: 1 }}>
                          🙏 ग्रीवांस आईक्यू में आपका स्वागत है! • Welcome to GrievancelQ!
                        </Typography>
                        <Typography>
                  ...
                  {documents.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 6 }}>
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                        Upload your first document to get started with GrievancelQ
                      </Typography>
                      <Button
                        variant="contained"
                        startIcon={<CloudUpload />}
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    <Paper sx={{ p: 2 }}>
                      ...
                      <Typography variant="body2">
                        • AI Model: {selectedAnalysis.aiModel || 'GrievancelQ-AI-v2.1'}
                      </Typography>
                      <Typography variant="body2">
