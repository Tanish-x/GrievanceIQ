...
/**
 * MetaMask Wallet Component for GrievancelQ
...
const MetaMaskWallet = ({ onWalletConnect, onWalletDisconnect }) => {
    ...
    const connectWallet = async () => {
        try {
            ...
            try {
                ...
                if (result.success) {
                    localStorage.setItem('grievancelq_wallet_session', result.data.sessionToken);
                }
            } catch (backendError) {
    ...
    const disconnectWallet = () => {
        ...
        localStorage.removeItem('grievancelq_wallet_session');
